...
def setup_product():
    ...
    import vs.contentnavigation
    zcml.load_config('configure.zcml', vs.contentnavigation)
    ...
    ztc.installPackage('vs.contentnavigation')
...
setup_product()
ptc.setupPloneSite(products=['vs.contentnavigation'])
